...
'''
Embodiments for two same sized embodiments. Mostly to use older recorded data.
'''
...
class GazeboEnvOld(gym.Env):
    ...
    def __init__(self, step_size, duration, bagfiles, e_embodiment, l_embodiment):
        ...
        :param l_embodiment: The learner embodiment.
        """
        super(GazeboEnvOld, self).__init__()
        self.current_step = 0
        self.done = False
...
class GazeboEvalEnvOld(GazeboEnvOld):
    """
    ...
    """
    def __init__(self, step_size, duration, bagfiles, e_embodiment, l_embodiment):
        super(GazeboEvalEnvOld, self).__init__(step_size, duration, bagfiles, e_embodiment, l_embodiment)
...
if __name__ == '__main__':
    env = GazeboEnvOld(0.1, 5.0, ['../resources/torque_trajectory_007.bag'], example_embodiments.panda_embodiment, example_embodiments.panda_embodiment)
    env.reset()
    #quit()
